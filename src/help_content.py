...
CONTEXT_HELP: dict[str, dict[str, dict[str, str]]] = {
    "overview": {
        ...
        "en": {
            ...
            "controls": "The date changes the diagnosis. Advanced mode exposes period, threshold, and persistence-window controls.",
    ...
    "quality_representativeness": {
        ...
        "en": {
            ...
            "controls": "The date selects the daily assessment. Advanced mode shows rules and diagnostic series.",
    ...
    "data_methods": {
        ...
        "en": {
            ...
            "controls": "Switch to Advanced mode to view internal detection and linking parameters.",
